...
public class GoatConfig {
    ...
    public static ForgeConfigSpec.DoubleValue DROP_HORN_PROBABILITY;
    ...
    private static void setupCommonConfig(ForgeConfigSpec.Builder builder) {
        ...
        MIN_GOAT_CHEESE = builder.comment("Minimum amount of goat cheese you will get from cheese making.").defineInRange("min_goat_cheese", 1, 0, 10);
        MAX_GOAT_CHEESE = builder.comment("Maximum amount of goat cheese you will get from cheese making.").defineInRange("max_goat_cheese", 1, 0, 10);
        builder.pop();
        ...
        DROP_HORN_PROBABILITY = builder.comment("Probability to drop the horns when losing them.").defineInRange("drop_horns_probability", 0.85, 0, 1);
        builder.pop();
    }
}
